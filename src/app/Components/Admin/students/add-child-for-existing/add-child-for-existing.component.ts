...
@Component({
  selector: 'app-add-child-for-existing',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './add-child-for-existing.component.html',
  styleUrls: ['./add-child-for-existing.component.css']
})
export class AddChildForExistingComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.childService.createChild(formData).subscribe(
      () => {
        ...
        this.router.navigate(['/admin-dashboard/students/all-students']); // Navigate to parent-child route
      },
      error => {
